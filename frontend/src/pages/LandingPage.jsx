  ...
  return (
    <div ref={pageRef} className="relative min-h-screen pt-32 pb-20 px-6 overflow-x-hidden bg-[#fafafa]">
      ...
      >
        ...
        >
          Get past the ATS with our AI-powered resume scanner and generator, then practice real interviews with a live AI interviewer to walk into every interview ready.
        </motion.p>
      ...
      <section id="features" className="max-w-6xl mx-auto mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            { icon: '✍️', title: 'AI Resume Generator', desc: 'Auto-generate a stunning, ATS-optimized HTML resume. Fill in missing gaps with our AI wizard and export as PDF or DOCX in one click.', color: 'bg-pink-100 text-pink-600' },
            ...
            { icon: '🎙️', title: 'Speech & Filler Word Detection', desc: 'We track words per minute, pause frequency, and filler words like "um" — and show you exactly when they happened.', color: 'bg-orange-100 text-orange-600' },
      ...
      <section className="max-w-6xl mx-auto mb-32 px-4">
        <RevealSection className="text-center mb-8">
          <span className="inline-flex items-center gap-2 text-purple-600 bg-purple-100 px-3 py-1 rounded-full text-xs font-bold mb-3">
            ✨ Interactive Particle Engine
          </span>
          <h2 className="text-3xl sm:text-4xl font-bold text-black tracking-tight mb-2">
            Experience the Future of Prep
          </h2>
          <p className="text-slate-500 text-sm max-w-lg mx-auto">
            Move your cursor over the particle field to interact with the text.
          </p>
        </RevealSection>

        <div className="w-full h-[360px] sm:h-[420px] rounded-3xl overflow-hidden shadow-2xl relative bg-[#0d091a] border border-purple-900/30 p-4 group">
          {/* Subtle ambient brand backdrop glows */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[var(--brand-primary)]/20 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute -top-10 -right-10 w-64 h-64 bg-indigo-600/15 rounded-full blur-[80px] pointer-events-none" />
